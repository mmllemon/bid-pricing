...
> 生成于 **2026-09-17 00:01:40** ｜ 合同基准日 `2026-03-01`
...
- 提交：`44d34ed` ｜ 累计 29 次提交
- 最新提交信息：feat(t01-06): 三项 Phase 0 声明落值 —— validate-boq 全绿，WP1 → Gate 1 判据达成
- 最近里程碑标签：`phase0-declarations-v1`
- 工作区：有 9 处未提交改动
...
| 制品 key | 类型 | hash | 冻结时间 |
|---|---|---|---|
| `rule_set_selector_spec` | versioned | sha256:0dd335b5a8ae | 2026-09-16T15:59:17+00:00 |
| `field_schema_version` | versioned | sha256:330cf6165ad9 | 2026-09-16T15:59:17+00:00 |
| `constraint_schema_version` | versioned | sha256:771e84c8ec74 | 2026-09-16T15:59:17+00:00 |
| `precision_profile_version` | versioned | sha256:6ce483e8d221 | 2026-09-16T15:59:17+00:00 |
| `architecture_decision_version` | versioned | sha256:3601adeed46c | 2026-09-16T15:59:17+00:00 |
| `competitiveness_classification` | versioned | sha256:2913378715d5 | 2026-09-16T15:59:17+00:00 |
| `input_protocol_schema` | versioned | sha256:1696175b90ff | 2026-09-16T15:59:17+00:00 |
| `canonical_schema_version` | versioned | sha256:ff90d54cbb5e | 2026-09-16T15:59:17+00:00 |
| `pricing_rule_card_version` | versioned | sha256:cf6efb75b63c | 2026-09-16T15:59:17+00:00 |
...
- 跨制品一致性：**PASS**（15/15 项判据通过） —— 判「已冻结制品彼此是否自洽」，与闸门正交；两者的关系是「hash 对不对」与「说法一致不一致」，缺一不可
...
| WP | 任务数 | 状态分布 |
|---|---|---|
| WP0 | 15 | done 8、not_started 5、partial 2 |
