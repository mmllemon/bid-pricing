...
> 生成于 **2026-09-17 16:46:23** ｜ 合同基准日 `2026-03-01`
...
- 提交：`1f3afc6` ｜ 累计 53 次提交
- 最新提交信息：feat(t03-02): 派生量计算（L/U/floor/r_eff 唯一实现）+ 闭合 T04-02D 的 SV-07 挂账（ADR-0025）
...
| 制品 key | 类型 | hash | 冻结时间 |
|---|---|---|---|
| `rule_set_selector_spec` | versioned | sha256:0dd335b5a8ae | 2026-09-17T08:41:37+00:00 |
| `field_schema_version` | versioned | sha256:0745655aa4b6 | 2026-09-17T08:41:37+00:00 |
| `constraint_schema_version` | versioned | sha256:bccb081ed800 | 2026-09-17T08:41:37+00:00 |
| `precision_profile_version` | versioned | sha256:146e8e6ffbc4 | 2026-09-17T08:41:37+00:00 |
| `architecture_decision_version` | versioned | sha256:3601adeed46c | 2026-09-17T08:41:37+00:00 |
| `competitiveness_classification` | versioned | sha256:2913378715d5 | 2026-09-17T08:41:37+00:00 |
| `input_protocol_schema` | versioned | sha256:1696175b90ff | 2026-09-17T08:41:37+00:00 |
| `canonical_schema_version` | versioned | sha256:ff90d54cbb5e | 2026-09-17T08:41:37+00:00 |
| `pricing_rule_card_version` | versioned | sha256:d88298683924 | 2026-09-17T08:41:37+00:00 |
...
> 共 31 项。生效状态由「人工声明」与「证据核对」共同决定（见 `src/bidpricing/status.py::effective_status`）。
...
| T03-03 | WP3 | Phase 0 预检与可行性证书 | 预检引擎 | not_started |
| T03-04 | WP3 | 约束判定器 | 判定器 | not_started |
| T04-01 | WP4 | Phase 1 解析解 | 排序+二分+贪心定容 | not_started |
